...
# 메소드: 특정한 객체를 통해서만 호출할 수 있는 함수

# 문자열 메소드

# 1. format() 메소드: 문자열에 변수를 삽입 or 형식을 지정하는데 사용
print('Hello, {}. I am {} years old'.format('jiwon', 16))
...
print('   Hello   '.lstrip()) # 문자열 왼쪽 끝의 공백 및 다른 특정 문자를 제거
print('   Hello   '.rstrip()) #문자열 오른쪽 끝의 공백 및 다른 특정 문자를 제거